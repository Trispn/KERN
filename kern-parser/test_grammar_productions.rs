...
fn test_entity_definition() {
    ...
    // Verify first entity
    if let kern_parser::Definition::Entity(entity) = &program.definitions[0] {
    ...
    if let kern_parser::Definition::Entity(entity) = &program.definitions[1] {
...
fn test_rule_definition() {
    ...
    if let kern_parser::Definition::Rule(rule) = &program.definitions[0] {
...
fn test_conditions_with_logical_ops() {
    ...
    if let kern_parser::Definition::Rule(rule) = &program.definitions[1] {
...
fn test_if_control_action() {
    ...
    if let kern_parser::Definition::Flow(flow) = &program.definitions[0] {
...
fn test_constraint_definition() {
    ...
    if let kern_parser::Definition::Constraint(constraint) = &program.definitions[0] {
...
fn test_multiple_definition_types() {
    ...
    for def in &program.definitions {
        match def {
            kern_parser::Definition::Entity(_) => entity_count += 1,
            kern_parser::Definition::Rule(_) => rule_count += 1,
            kern_parser::Definition::Flow(_) => flow_count += 1,
            kern_parser::Definition::Constraint(_) => constraint_count += 1,
        }
    }
...
#[test]
fn test_incomplete_entity_definition() {
...
#[test]
fn test_incomplete_rule_definition() {
